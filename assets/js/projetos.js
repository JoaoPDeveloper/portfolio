...
function alterarTemaSite() {  
 ...
 if (tema === 'dark') {
   ...
   document.querySelector("#alterarTemaSite").innerHTML = `Dark Mode <i class="bi bi-moon-stars"></i>`;
   ...
   document.querySelector("#alterarTemaSite").innerHTML = `Light Mode <i class="bi bi-brightness-high-fill">`;
