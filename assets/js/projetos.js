...
function zoomImg(posicao) {
  ...
  document.querySelector("#modalZoomImgDescricaoProjeto").innerHTML =
    projeto.descricao;
...
function alterarTemaSite() {
  ...
  if (tema === "light") {
    ...
    document.querySelector("#languagesContainer").style.color = "white";
    document.querySelector(".icon3 img").src =
      "https://images.emojiterra.com/google/noto-emoji/unicode-15/color/svg/1f680.svg";
    ...
    document.querySelector(
      "#alterarTemaSite"
    ).innerHTML = ` <i class="bi bi-moon-stars"></i>`;
    ...
    document.querySelector("#languagesContainer").style.color = "yellow";
    document.querySelector(".icon3 img").src =
      "https://www.svgrepo.com/show/494569/rocket-innovation-space.svg'";
